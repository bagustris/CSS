...
def test(
    ...
    with torch.no_grad():
        ...
        # print(f"acc_control: {control_target}")
...
def run_test(
    args, checkpoint_path, testloader, c, model_name, ap, cuda=True,
    debug=False
):
    ...
    if checkpoint_path is not None:
        ...
        try:
            ...
            raise ValueError(
                "You need pass a valid checkpoint, may be you need check your config.json because of this checkpoint cause the error: "
                + e
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--no_insert_noise", type=bool, default=True, help=" No insert noise in test ?"
    )
    parser.add_argument(
        "--num_noise_control",
        type=int,
    ...
    parser.add_argument(
        "--debug", type=bool, default=True, help=" Print classification error"
    )
