...
class AudioProcessor(object):
    def __init__(
        ...
        valid_features = ["spectrogram", "melspectrogram", "mfcc", "wavlm"]
        if self.feature == "wavlm":
    ...
    def wav2feature(self, y):
        if self.feature == "spectrogram":
            ...
            audio_class = torchaudio.transforms.MelSpectrogram(
            ...
            audio_class = torchaudio.transforms.MFCC(
                sample_rate=self.sample_rate,
