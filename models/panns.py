...
class Cnn14(nn.Module):
    def __init__(self, classes_num, spec_aug=True):
        ...
        self.amplitude_to_DB = torchaudio.transforms.AmplitudeToDB("power", 
            top_db)
...
class Transfer_Cnn14(nn.Module):
    ...
    def load_from_pretrain(self, pretrained_checkpoint_path):
        ...
        try:
            ...
            print("Partial Pretrained checkpoint loaded: ",
...
class ResNet38(nn.Module):
    def __init__(self, classes_num, spec_aug=True):
        ...
        top_db = None
        self.spec_aug = spec_aug
        # torchaudio generate mel spectogram without logmel so we need aplied log mel because panns is trained with this
        self.amplitude_to_DB = torchaudio.transforms.AmplitudeToDB("power", 
            top_db)
        ...
        self.resnet = _ResNet(
            block=_ResnetBasicBlock, layers=[3, 4, 6, 3],
